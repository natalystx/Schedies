        ...
        child: SizedBox(
          ...
          child: StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              fcmList.contains(snapshot.data['fcmToken'])
                  ? fcmList = fcmList
                  : fcmList.add(snapshot.data['fcmToken']);
              return Stack(
                fit: StackFit.expand,
                children: <Widget>[
                  Form(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount: _moreInviteProfile.length,
                                                  ...
                                                  if (startTime.isNotEmpty &&
                                                    ...
                                                    if (snapshot.hasData &&
                                                      ...
                                                      snapshot.data.documents
                                                        ...
                                                        bool isOverlap = (startTimeTemp
                                                                .isBefore(
                                                                    docEndTime) &&
                                                            docStartTime.isBefore(
                                                                endTimeTemp));
