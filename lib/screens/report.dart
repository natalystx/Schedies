              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      FlatButton(
                        color: _selectedShowView == 'day' ? Colors.white : null,
                        onPressed: () {
                          setState(() {
                      ...
                      FlatButton(
                        color:
                            _selectedShowView == 'month' ? Colors.white : null,
                        onPressed: () {
                          setState(() {
                  ...
                  StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      return Padding(
                        padding: const EdgeInsets.only(bottom: 20.0),
                        child: CalendarCarousel(user.uid, isMe: true, document: snapshot.data,),
                      );
                    }
                  ),
                  Padding(
